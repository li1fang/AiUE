...
$ScriptPath = Join-Path $RepoRoot "workflows\pmx_pipeline\run_playable_demo_e2_review_history.py"
...
if ($ReplayReportPath) { $Args += @("--replay-report-path", $ReplayReportPath) }
