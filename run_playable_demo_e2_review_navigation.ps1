...
$ScriptPath = Join-Path $RepoRoot "workflows\pmx_pipeline\run_playable_demo_e2_review_navigation.py"
...
if ($ReviewReportPath) { $Args += @("--review-report-path", $ReviewReportPath) }
