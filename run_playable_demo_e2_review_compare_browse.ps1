...
$ScriptPath = Join-Path $RepoRoot "workflows\pmx_pipeline\run_playable_demo_e2_review_compare_browse.py"
...
if ($CompareReportPath) { $Args += @("--compare-report-path", $CompareReportPath) }
