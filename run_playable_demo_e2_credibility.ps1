...
$scriptPath = Join-Path $PSScriptRoot "workflows\pmx_pipeline\run_playable_demo_e2_credibility.py"
if (-not (Test-Path -LiteralPath $pythonExe)) {
    throw "E2A credibility gate requires the repo tooling env python: $pythonExe"
}
