...
COMMANDS = {
    ...
    "inspect-source-handoff-mesh-visual": {"module": "inspect_source_handoff_mesh_visual", "category": "probe", "workflow_pack": "body_platform", "destructive": False},
    "inspect-visible-conflict": {"module": "inspect_visible_conflict", "category": "probe", "workflow_pack": "pmx_pipeline", "destructive": False},
