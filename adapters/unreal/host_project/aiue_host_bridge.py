...
def run_command(
    ...
    effective_mode = mode
    if command in {"import-package", "load-level", "spawn-host", "capture-frame", "run-scene-sweep", "inspect-stage-anchors", "ensure-stage-anchors", "inspect-host-visual", "inspect-live-fx-visual-pair", "inspect-slot-runtime", "stage-capture", "action-preview", "animation-preview", "retarget-preflight", "retarget-bootstrap", "retarget-author-chains"} and not dry_run and mode != "editor_rendered":
